            ...
            animateLightIcon
                ? AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: value ? const Color(0xFFFFF8D9) : const Color(0xFFF0F7FF),
                      boxShadow: value
                          ? [
                              BoxShadow(
                                color: const Color(0xFFFFD84D).withValues(alpha: 0.65),
                                blurRadius: 18,
                                spreadRadius: 1.5,
                              ),
                            ]
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: Icon(
                        ...
                        key: ValueKey(value),
                        color: value ? const Color(0xFFFFC107) : AppColors.lightGrayColor,
                        size: height * 0.055,
                      ),
                    ),
                  )
